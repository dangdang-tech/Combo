...
import { getChartPalette, type ChartPalette } from './theme.js';
...
export function SessionHeatmap({
  ...
  return (
    <div className="cb-heatmap">
      <EChart
        option={buildHeatmapOption(heatmap, palette)}
        height={height}
