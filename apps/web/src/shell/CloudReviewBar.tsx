...
export function CloudReviewBar(): ReactElement | null {
  ...
  return (
    <aside className="cb-cloud-review" aria-label="云端评审环境">
      <div className="cb-cloud-review__identity">
        <span className="cb-cloud-review__pulse" aria-hidden="true" />
        <strong>云端评审</strong>
        <span>独立数据 · Build {shortSha}</span>
      </div>
